...
addTechBtn.addEventListener('click', function (ev){
    ...
    const expRadiol = creatInput(id1, '0-2 anos', 'techExp-' + rowIndex, 'radio')
    ...
    newRow.append(
        techNameLabel, techNameInput, expLabel, expRadiol, expLabel1, expRadio2, expLabel2,
        expRadio3, expLabel3, removeRowBtn
    )
